<template>
  <div style="margin-bottom: 20px; ">
    <el-breadcrumb style="font-size: 14px; margin-bottom: 20px;" separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/manage_bug' }">缺陷管理</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      ...
      <div>
        <el-table :data="tableData" style="width: 100%" height=500
                  :default-sort="{prop: ['id','name','beginTime','endTime','status'], order: 'descending'}">
          ...
          <el-table-column label="操作" align='center' width="100">
            <template slot-scope="ss">
              <el-button type="primary" style="width: 60px;font-size: 12px;padding: 0px;height: 40px;"
                         @click="facilityManage(ss.row.id);" plain>缺陷管理
              </el-button>
            </template>
          </el-table-column>
        </el-table>
