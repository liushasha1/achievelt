<template>
  <div style="margin-bottom: 20px; ">
    <el-breadcrumb style="font-size: 14px; margin-bottom: 20px;" separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/manage_facility' }">设备管理</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      ...
      <div>
        <el-table :data="tableData" height=500 style="width: 100%" :default-sort="{prop: ['id','name','beginTime','endTime','status'], order: 'descending'}">
