<template>
  <div style="margin-bottom: 30px; ">
    <el-breadcrumb style="font-size: 14px; margin-bottom: 20px;" separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/audit_file' }">审核归档</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
         ...
         <el-table-column prop="status" label="项目状态" align='center' sortable width="100">
          ...
          <el-table-column label="操作" align='center' width="250">
            <template slot-scope="scope">
              <el-button type="primary" style="width: 60px;font-size: 12px;padding: 0px;height: 40px;" @click="fileDetail"
                plain>详情</el-button>
